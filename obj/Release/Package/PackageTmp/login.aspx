<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="DeduccionIMP.login" %>
        ...
        <div class="formcontent">
            <form id="formulario_login" runat="server">
                <div class="form-control">
                    ...
                    <br />
                    <div class="row">
                        <asp:Button ID="BtnIngresar" CssClass="btn btn-primary btn-dark" runat="server" Text="Ingresar" OnClick="BtnIngresar_Click1"/>
                    </div>
                </div>
            </form>
        </div>
